...
let g:tex_last_section_level = 0
...
function! GetTeXIndent() " {{{
    ...
    " add a 'shiftwidth' at the beginning of sections
    ...
    " and remove it at the end
    if cline =~ '\\section'
        if g:tex_last_section_level == 1
            let ind = ind - &sw
        elseif g:tex_last_section_level == 2
            let ind = ind - &sw - &sw
        elseif g:tex_last_section_level == 3
            let ind = ind - &sw - &sw - &sw
        endif
        let g:tex_last_section_level = 1
    elseif cline =~ '\\subsection'
        if g:tex_last_section_level == 2
            let ind = ind - &sw
        elseif g:tex_last_section_level == 3
            let ind = ind - &sw - &sw
        endif
        let g:tex_last_section_level = 2
    elseif cline =~ '\\subsubsection'
        if g:tex_last_section_level == 3
            let ind = ind - &sw
        endif
        let g:tex_last_section_level = 3
    endif
